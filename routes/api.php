...
Route::post('/articulos','App\Http\Controllers\ArticuloController@store'); //crear un registros
Route::put('/articulos{id}','App\Http\Controllers\ArticuloController@update'); //actualizar un registro 
Route::delete('/articulos','App\Http\Controllers\ArticuloController@destroy'); 